                ...
                <div class="lg:w-3/4 lg:px-20 space-y-7">
                    <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                        ...
                        <div class="p-4 space-y-3 relative">
                            <div class="text-2xl font-semibold pt-2"> Product title</div>
                            ...
                            <div class="flex space-x-3 items-center text-sm md:pt-3">
                                <div> Central Park N902</div>
                                <div class="md:block hidden">·</div>
                                <div class="font-semibold text-yellow-500"> Instock</div>
                                <div class="flex"> Brand: <span class="font-semibold text-yellow-500 mr-2">Cocoil </span> </div>
                            </div>

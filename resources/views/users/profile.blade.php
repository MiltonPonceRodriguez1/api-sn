        ...
        <div class="mcontainer">
            ...
            <div class="profile user-profile">
                ...
                <div class="profiles_banner">
                    @if ($user->cover && $user->cover != 'default.png')
                        <div uk-lightbox>
                            <a href="{{ env('URL_ROOT') }}user/cover/{{ $user->cover }}">
                                <img src="{{ env('URL_ROOT') }}user/cover/{{ $user->cover }}" alt="banner">
                            </a>
                        </div>
                    @else
                        <a href="{{ asset('assets/images/avatars/profile-cover.jpg') }}">
                    ...
                    <div class="profile_action absolute bottom-0 right-0 space-x-1.5 p-3 text-sm z-50 hidden lg:flex">
                        ...
                        <a href="#" uk-toggle="target: #upload-cover-modal" uk-tooltip="title: Sube tu foto de portada; pos: top" class="flex items-center justify-center h-8 px-3 rounded-md bg-gray-700 bg-opacity-70 text-white space-x-1.5">
                    ...
                    <div class="profile_avatar">
                        <div class="profile_avatar_holder">
                            @if ($user->avatar && $user->avatar != 'default.png')
                                <div uk-lightbox>
                                    <a href="{{ env('URL_ROOT') }}user/avatar/{{ $user->avatar }}">
                                        <img src="{{ env('URL_ROOT') }}user/avatar/{{ $user->avatar }}" alt="avatar">
                                    </a>
                                </div>
                            @else
                                <img src="{{ asset('assets/images/avatars/avatar-8.jpg') }}" alt="avatar">
                            @endif
                        </div>
                        <div class="user_status status_online" hidden></div>
                        <div class="icon_change_photo" uk-toggle="target: #update-user-modal" uk-tooltip="title: Sube tu avatar; pos: top">
                            <span class="icon-feather-camera"></span>
                        </div>
                    </div>

                    <div class="profile_info">
                        @if ($user->name && $user->surname && $user->nickname)
                            <h1>{{ $user->name }} {{ $user->surname }} </h1>
                            <p class="text-center">&commat;{{ $user->nickname }}</p>
                        @endif
                    </div>
                    ...
                    <div class="space-y-5 flex-shrink-0 md:w-7/12">
                        ...
                        <div>
                            @if (session('status_avatar'))
                                @if(session('status_avatar') === 'success')
                                    <div class="bg-green-500 border p-4 relative rounded-md uk-alert" uk-alert="">
                                        <button class="uk-alert-close absolute bg-gray-100 bg-opacity-20 m-5 p-0.5 pb-0 right-0 rounded text-gray-200 text-xl top-0">
                                            <i class="icon-feather-x"></i>
                                        </button>
                                        <h3 class="text-lg font-semibold text-white">Exito!</h3>
                                        <p class="text-white text-opacity-75">Avatar actualizado correctamente!</p>
                                    </div>
                                @else
                                    <div class="bg-red-500 border p-4 relative rounded-md uk-alert" uk-alert="">
                                        <button class="uk-alert-close absolute bg-gray-100 bg-opacity-20 m-5 p-0.5 pb-0 right-0 rounded text-gray-200 text-xl top-0">
                                            <i class="icon-feather-x"></i>
                                        </button>
                                        <h3 class="text-lg font-semibold text-white">Error!</h3>
                                        <p class="text-white text-opacity-75">Error al actualizar el avatar!</p>
                                    </div>
                                @endif
                            @endif
                        </div>
                        ...
                        <div class="card lg:mx-0 p-4" uk-toggle="target: #create-post-modal">
                            <div class="flex space-x-3">
                                ...
                                @if ($user->avatar && $user->avatar != 'default.png')
                                    <img src="{{ env('URL_ROOT') }}user/avatar/{{ session('avatar') }}" class="w-10 h-10 rounded-full" alt="avatar">
                                @else
                                    <img src="{{ asset('/assets/images/avatars/avatar-2.jpg') }}" class="w-10 h-10 rounded-full" alt="avatar">
                                @endif

                                <input placeholder="¿Qué estás pensando {{ $user->name }}?" class="bg-gray-100 hover:bg-gray-200 flex-1 h-10 px-6 rounded-full">
                            </div>
                    ...
                    <div class="w-full space-y-6">
                        ...
                        <div class="widget card p-5 border-t">
                            ...
                            <div class="grid grid-cols-3 gap-3 text-gray-600 font-semibold">
                                ...
                                <a href="#">
                                    <div class="avatar relative rounded-md overflow-hidden w-full h-24 mb-2">
                                        <img src="{{ asset('assets/images/avatars/avatar-2.jpg') }}" alt="" class="w-full h-full object-cover absolute">
                                    </div>
                                    <div class="text-sm truncate"> Erica Jones </div>
                                </a>
                                <a href="#">
                                    <div class="avatar relative rounded-md overflow-hidden w-full h-24 mb-2">
                                        <img src="{{ asset('assets/images/avatars/avatar-3.jpg') }}" alt="" class="w-full h-full object-cover absolute">
                                    </div>
                                    <div class="text-sm truncate"> Stella Johnson </div>
                                </a>
                                <a href="#">
                                    <div class="avatar relative rounded-md overflow-hidden w-full h-24 mb-2">
                                        <img src="{{ asset('assets/images/avatars/avatar-4.jpg') }}" alt="" class="w-full h-full object-cover absolute">
                                    </div>
                                    <div class="text-sm truncate"> Alex Dolgove</div>
                                </a>
                                <a href="#">
                                    <div class="avatar relative rounded-md overflow-hidden w-full h-24 mb-2">
                                        <img src="{{ asset('assets/images/avatars/avatar-5.jpg') }}" alt="" class="w-full h-full object-cover absolute">
                                    </div>
                                    <div class="text-sm truncate"> Jonathan Ali </div>
                                </a>
                                <a href="#">
                                    <div class="avatar relative rounded-md overflow-hidden w-full h-24 mb-2">
                                        <img src="{{ asset('assets/images/avatars/avatar-6.jpg') }}" alt="" class="w-full h-full object-cover absolute">
                                    </div>
...
<!-- Update user modal -->
<div id="update-user-modal" class="create-post is-story" uk-modal>
    <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical rounded-lg p-0 lg:w-5/12 relative shadow-2xl uk-animation-slide-bottom-small">

        <div class="text-center py-3 border-b">
            <h3 class="text-lg font-semibold"> Actualiza tu Avatar! </h3>
            <button class="uk-modal-close-default bg-gray-100 rounded-full p-2.5 right-2" type="button" uk-close uk-tooltip="title: Close ; pos: bottom ;offset:7"></button>
        </div>

        <form method="POST" action="{{ route('user.upload', ['disk' => 'avatars']) }}" enctype="multipart/form-data">
            @csrf

            <div class="bsolute bottom-0 p-4 space-x-4 w-full">
                <div id="file-upload-avatar" class="flex bg-gray-50 border border-purple-100 rounded-2xl p-2 shadow-sm items-center file-upload">
                    <div class="lg:block hidden ml-1"> Selecciona tu avatar... </div>
                    <div class="flex flex-1 items-center lg:justify-end justify-center space-x-2">
                        ...
                        <input type="file" id="avatar" name="file0" style="display: none;">
                    </div>
                </div>
            </div>
...
<!-- Cover user modal -->
<div id="upload-cover-modal" class="create-post is-story" uk-modal>
    <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical rounded-lg p-0 lg:w-5/12 relative shadow-2xl uk-animation-slide-bottom-small">

        <div class="text-center py-3 border-b">
            <h3 class="text-lg font-semibold"> Actualiza tu portada! </h3>
            <button class="uk-modal-close-default bg-gray-100 rounded-full p-2.5 right-2" type="button" uk-close uk-tooltip="title: Close ; pos: bottom ;offset:7"></button>
        </div>

        <form method="POST" action="{{ route('user.upload', ['disk' => 'covers']) }}" enctype="multipart/form-data">
            @csrf

            <div class="bsolute bottom-0 p-4 space-x-4 w-full">
                <div id="file-upload-cover" class="flex bg-gray-50 border border-purple-100 rounded-2xl p-2 shadow-sm items-center file-upload">
                    <div class="lg:block hidden ml-1"> Selecciona tu portada... </div>
                    <div class="flex flex-1 items-center lg:justify-end justify-center space-x-2">
                        ...
                        <input type="file" id="cover" name="file0" style="display: none;">
                    </div>
                </div>
            </div>
            <div class="flex items-center w-full justify-end border-t p-3">
...
<script>
    init_Event('file-upload-avatar', 'avatar');
    init_Event('file-upload-cover', 'cover');
</script>
@endsection
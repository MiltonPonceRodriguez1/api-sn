    ...
    <div class="header_wrap">
        <div class="header_inner mcontainer">
            ...
            <div class="header_search"><i class="uil-search-alt"></i>
                <input value="" type="text" class="form-control" placeholder="Buscar contanctos , Vídeos y más.." autocomplete="off">
                <div uk-drop="mode: click" class="header_search_dropdown">

                    <h4 class="search_title"> Recientemente </h4>
                    <ul>
                        <li>
                            <a href="#">
                                <img src="{{ asset('assets/images/avatars/avatar-1.jpg') }}" alt="" class="list-avatar">
                                <div class="list-name"> Antonio Flores </div>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="right_side">
                ...
                <div class="header_widgets">
                    ...
                    <!-- NOTIFICACIONES -->
                    <!-- <a href="#" class="is_icon" uk-tooltip="title: Notificaciones">
                    ...
                    <!-- Message -->
                    <!-- <a href="#" class="is_icon" uk-tooltip="title: Mensajes">
                        <svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div uk-drop="mode: click" class="header_dropdown is_message">
                        <div class="dropdown_scrollbar" data-simplebar>
                            ...
                            <ul>
                                <li class="un-read">
                                    <a href="#">
                                        <div class="drop_avatar"> <img src="{{ asset('assets/images/avatars/avatar-7.jpg') }}" alt="">
                                        </div>
                                        <div class="drop_text">
                        ...
                        <a href="#" class="see-all"> Ver todos los mensajes</a>
                    </div> -->


                    <a href="#">
                        @if (session('avatar') != 'default.png')
                        <img src="{{ env('URL_ROOT') }}user/avatar/{{ session('avatar') }}" class="is_avatar" alt="">
                        @else
                    ...
                    <div uk-drop="mode: click;offset:5" class="header_dropdown profile_dropdown">
                        ...
                        <a href="{{ route('profile', ['id' => session('id')]) }}" class="user">
                        <div class="user_avatar">
                                        <img src="{{ env('URL_ROOT') }}user/avatar/{{ session('avatar') }}" class="is_avatar_dropwdown" alt="">
                                    </div>    
                        <!-- <div class="user_avatar">
                                @if (session('avatar') != 'default.png')
                                <img src="{{ env('URL_ROOT') }}user/avatar/{{ session('avatar') }}" class="is_avatar" alt="">
                            ...
                            <div class="user_name">
                                @if (session('name') && session('surname') && session('nickname'))
                                <div>{{ session('name') }} {{ session('surname') }} </div>
                                <span>&commat;{{ session('nickname') }}</span>
                                @endif
                            </div>
                        </a>
                        <hr>
                        <a href="{{ route('upgrade.plans') }}" class="is-link">
                            <svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="{{ route('profile', ['id' => session('id')]) }}">
                            <svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
